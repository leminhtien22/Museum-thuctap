            ...
            @forelse ($data as $item)
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    <a href="{{ route('client.exhibition.details', $item->id) }}">
                        <img class="rounded-t-lg object-cover aspect-video" src="{{ asset('storage/' . $item->image) }}"
                            alt="" />
                    </a>
                    ...
                    <div class="p-5">
                        ...
                        <p
                            ...
                            <span class="font-semibold">Bắt đầu</span>
                        ...
                        <p class="font-normal line-clamp-1 text-gray-700">
                            <span class="font-semibold">Kết thúc</span>
